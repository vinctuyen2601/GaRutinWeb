    ...
    <>
      ...
      <section className="bg-gradient-to-br from-primary-800 to-primary-600 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-block bg-primary-500 text-primary-100 text-sm font-medium px-4 py-1.5 rounded-full mb-4">
            🌟 Gà tí hon nhỏ nhất thế giới — đang hot tại Việt Nam 2026
          </div>
          ...
          <p className="text-primary-200 mb-8 max-w-2xl mx-auto">
            ...
            nhiều màu — xanh, nâu, trắng, bạc, maroon... Tính cách hiền lành, ít
            mùi, dễ nuôi trong căn hộ. Giống thuần chủng, con khỏe, đẹp mã, giao
            hàng toàn quốc.
          </p>
      ...
      <section className="py-8 bg-primary-50">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          {[
            {
              icon: "🎨",
              title: "Nhiều màu lông đẹp",
              desc: "Xanh, trắng, bạc, maroon, nâu...",
            },
            {
              icon: "🏠",
              title: "Nuôi được trong nhà",
              desc: "Ít mùi, ít tiếng ồn, nhỏ gọn",
            },
            {
              icon: "🚚",
              title: "Giao toàn quốc",
              desc: "Đóng gói an toàn, đúng cách",
            },
            {
              icon: "✅",
              title: "Cam kết chất lượng",
              desc: "Con đẹp, khỏe, đúng giống",
            },
          ].map((u) => (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 shadow-sm mb-10">
            ...
            <p className="text-gray-500 text-sm mb-4">
              King Quail · Chinese Painted Quail · Coturnix chinensis
            </p>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Không giống gà thịt hay gà đẻ công nghiệp, gà Rutin được nuôi hoàn
              toàn <strong>làm cảnh và thú cưng</strong>. Tính cách hiền lành,
              ít mùi, ít tiếng ồn — rất phù hợp nuôi trong căn hộ, nhà phố hay
          ...
          <h2 className="text-2xl font-bold text-center mb-6">
            Tại sao chọn GaRutin?
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {
                icon: "🎨",
                title: "Giống đẹp, nhiều màu",
                desc: "Đàn gốc thuần chủng với đa dạng màu lông — xanh, trắng, bạc, maroon, nâu, đen. Con đực màu sắc rực rỡ, đẹp mã.",
              },
              {
                icon: "📦",
                title: "Vận chuyển an toàn",
                desc: "Đóng gói đúng kỹ thuật, thoáng khí, giảm stress cho chim. Cam kết giao đến tay khỏe mạnh, đúng giống.",
              },
              {
                icon: "🤝",
                title: "Hỗ trợ tận tình",
                desc: "Tư vấn miễn phí cách nuôi, chuồng trại, chế độ ăn và phòng bệnh. Đồng hành cùng bạn từ khi mua đến lúc thành thạo.",
              },
            ].map((item) => (
              <div
                key={item.title}
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {posts.map((post) => (
                ...
                >
                  ...
                  <div className="p-4">
                    <h3 className="font-semibold text-gray-800 line-clamp-2 mb-2 group-hover:text-primary-600 transition-colors">
                      {post.title}
                    </h3>
                    {post.excerpt && (
      ...
      <section className="py-12 bg-primary-700 text-white text-center px-4">
        <h2 className="text-2xl font-bold mb-3">
          Muốn sở hữu chú gà tí hon này?
        </h2>
        <p className="text-primary-200 mb-6">
          Liên hệ ngay để được tư vấn giống, màu lông và cách nuôi — hoàn toàn
          miễn phí
        </p>
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <a
